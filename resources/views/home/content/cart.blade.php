                                ...
                                <tr>
                                    <td scope="row">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ Storage::url($cart->product->photo) }}" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <p class="mb-0 mt-4">{{ $cart->price * $cart->qty }}</p>
                                    </td>
                                    <td>
                    ...
                    <div class="col-sm-8 col-md-7 col-lg-6 col-xl-4">
                        <div class="bg-light rounded">
                                ...
                                <h1 class="display-6 mb-4">Cart <span class="fw-normal">Total</span></h1>
                                    @foreach ($carts as $key => $cart )
                                        <div class="mb-3 d-flex justify-content-between">
                                            <p class="d-inline">{{ $cart->product->name }}</p>
                                            <p class="d-inline">{{ $cart->product->price }}</p>
                                            <p class="d-inline">{{ $cart->qty }}</p>
                                            <p class="d-inline">{{ $cart->price * $cart->qty }}</p>
                            ...
                            <div class="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
                                ...
                                <p class="mb-0 pe-4">{{ $total_biaya }}</p>
                            </div>
